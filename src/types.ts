...
export interface WdtSuccessResponse<TData extends JsonValue = JsonObject> {
  status: 0;
  message?: string;
  data?: TData;
  [key: string]: JsonValue | undefined;
...
export type WdtApiResponse<TData extends JsonValue = JsonObject> =
  | WdtSuccessResponse<TData>
  | WdtErrorResponse;
